...
//go:generate go run github.com/iamxvbaba/td/cmd/gotdgen --doc "https://core.telegram.org/" --clean --server --handlers --mapping --slices --package tg --target tg --schema-manifest _schema/layers/manifest.json --layer-policy _schema/layers/policy.json --layer-plan-audit _schema/layers/audit/execution-plans.json
